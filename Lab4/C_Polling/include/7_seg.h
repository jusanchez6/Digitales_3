/**
 * @file ./C_Polling/include/7_seg.h
 ...
 */
    ...
    /** @brief Máscara de los segmentos */
    #define SEGMENTS_MASK 0xFF<<START_PIN

    /** @brief Enable de la primer pantalla */
    #define EN_1 12

    /** @brief Enable de la segunda pantalla */
    #define EN_2 11

    /** @brief Enable de la tercer pantalla */
    #define EN_3 10
     ...
     * @param dp Booleano de punto decimal
     * 
     * @return void
     */
